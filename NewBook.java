...
public class NewBook extends JFrame {
	...
	public NewBook() {
		...
		btnSave.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try{
					Connection MyConn = DriverManager.getConnection("jdbc:mysql://localhost:3306/library_management_system", "root", "root");
	...
	//	contentPane.setFocusTraversalPolicy(new FocusTraversalPolicy(new Component[]{lblBookId, lblName, lblPublisher, lblPrice, lblPublisherYear, textField, textField_1, textField_2, textField_3, textField_4, btnSave, btnExit}));
	}
}
