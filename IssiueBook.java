...
public class IssiueBook extends JFrame {
	...
	public IssiueBook() {
		...
		JColorChooser dateChooser = new JColorChooser();
		dateChooser.setBounds(285, 200, 191, 31);
		contentPane.add(dateChooser);
		
		JColorChooser dateChooser_1 = new JColorChooser();
		...
		btnSave.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
		    	...
		    	String issiueDate = dFormat.format(null);
				String Duedate = dFormat.format(null);
